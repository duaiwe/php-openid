...
require_once 'Tests/Auth/OpenID/AuthRequest.php';
require_once 'Tests/Auth/OpenID/BigMath.php';
...
class Auth_OpenID_AllTests {
    ...
    public static function suite() {
        ...
        $suite->addTestSuite('Auth_OpenID_AuthRequestSuite');
        $suite->addTestSuite('Auth_OpenID_BigMathTest');
